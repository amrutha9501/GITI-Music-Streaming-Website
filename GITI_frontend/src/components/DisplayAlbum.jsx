        ...
        <>
            ...
            <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <p className='flex'>
                        <div>
                            {/* <img className='inline-block' src={assets.mini_logo} alt="GITI_logo" /> */}
                            <b className='mr-2'>GITI</b>
                        </div>
                ...
                <div
                    ...
                    onClick={() => {
                        if (track._id !== item._id) {
                            ...
                            playWithId(item._id);  // Start playing the new song.
                        } else if (playStatus) {
                            pause();  // If the same song is clicked again, just pause it.
                        } else {
                            play();  // If the same song was paused, play it.
                        }
                    }}
