...
function ListAlbum() {
    ...
    return (
        <div>
            <div>
                <div className="sm:grid hidden grid-cols-[0.5fr_1fr_2fr_1fr_0.5fr] items-center justify-items-center gap-2.5 p-3 border-[#b9b62b] text-sm mr-5 bg-[#b9b62b] ">
                    <b>Image</b>
                    <b>Name</b>
                    <b>Description</b>
                    <b>Album Colour</b>
                ...
                {data.map((item, index) => {
                    return (
                        <div key={index} className="grid grid-cols-[1fr_1fr_1fr] sm:grid-cols-[0.5fr_1fr_2fr_1fr_0.5fr] items-center justify-items-center gap-2.5 p-3 border border-gray-300 text-sm mr-5">
                            ...
                            <p className='font-bold cursor-pointer text-white hover:text-[#b9b62b]' onClick={() => removeAlbum(item._id)}>X</p>
                        </div>
                    )
                })}
            </div>
